...
COLORS = {
  ...
  # "bar_border"                               : [ LATTE.lavender.hex,  FRAPPE.lavender.hex ],
    ...
    "treetab_bg"                               : [ LATTE.surface0.hex,  FRAPPE.surface2.hex ],
    "treetab_active_bg"                        : [ LATTE.rosewater.hex, FRAPPE.rosewater.hex ],
    "treetab_fg"                               : [ LATTE.text.hex,      FRAPPE.text.hex ],
    "treetab_active_fg"                        : [ LATTE.crust.hex,     FRAPPE.crust.hex ],
    "treetab_urgent_fg"                        : [ LATTE.red.hex,       FRAPPE.red.hex ],
